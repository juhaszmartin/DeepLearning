...
from src.model import TimeSeriesTransformer, print_model_summary
from src.train import train_model, split_data
...
def main():
    ...
    # Set up logging (outputs to both file and stdout for Docker)
    logger = setup_logger(name='main', log_file='log/run.log')
    ...
    logger.info("Confusion matrices saved to plots/confusion_matrix_train.png and plots/confusion_matrix_test.png")
    ...
    logger.info(f"Binary confusion matrix saved to plots/binary_confusion_matrix.png")
